/**
 * GET  — le détail complet d'une copie de mathématiques : questions, blocs propres à
...
export async function GET(
  ...
  return lireCopie(correctionId, 'brevet_mathematiques');
}
...
export async function POST(
  ...
  const { correctionId } = await params;
  return agirSurCopie(req, correctionId, 'brevet_mathematiques');
}
