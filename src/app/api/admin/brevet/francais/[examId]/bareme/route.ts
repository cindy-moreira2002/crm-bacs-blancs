/**
 * PUT — enregistrer le barème d'un brevet blanc de français.
 *
 * Refuse d'écrire sur une version verrouillée (le trigger en base le refuse
 * aussi), et refuse toute clé qui appartient au barème de mathématiques : les
...
export async function PUT(req: NextRequest, { params }: { params: Promise<{ examId: string }> }) {
  ...
  return enregistrerBaremeBrevet(req, examId, 'brevet_francais');
}
