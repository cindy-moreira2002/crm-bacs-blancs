...
function LiensUtiles({
  ...
  const liens: { titre: string; sous: string; href: string; externe: boolean }[] = [
    ...
    { titre: '📧 E-mails automatiques', sous: 'File d’envoi et réglages', href: '/direction/emails', externe: false },
    { titre: '📝 Pilotage de la correction', sous: 'Copies, barèmes, coûts', href: '/direction/correction', externe: false },
  ];
