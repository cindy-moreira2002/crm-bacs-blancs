...
/**
 * /direction/brevet — l'entrée du diplôme national du brevet.
 *
 * Cette page existe pour rendre la séparation évidente dès le premier écran :
 * le baccalauréat vit dans /direction/bareme et /direction/correction, le brevet ici,
      ...
      <div className="max-w-5xl mx-auto space-y-8">
        <header className="border-b-4 border-teal-500 pb-5">
          <p className="text-sm text-gray-500">
            <Link href="/direction/correction" className="hover:underline">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          <CarteMatiere
            href="/direction/brevet/francais"
          ...
          />
          <CarteMatiere
            href="/direction/brevet/mathematiques"
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6">
          ...
          <p className="text-sm text-gray-600">
            ...
            <Link href="/direction/bareme" className="text-purple-700 underline">
              /direction/bareme
            </Link>
            , et le pilotage général sur{' '}
            <Link href="/direction/correction" className="text-purple-700 underline">
