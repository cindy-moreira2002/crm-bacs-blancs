...
/**
 * Garde commune aux pages `/direction/brevet/**`.
 *
 * Même règle que `/direction/bareme` : réservé à l'administratrice, parce qu'un
...
export async function gardeAdminPage(): Promise<React.ReactElement | null> {
  // Le brevet est éteint (`BREVET_ACTIF`) : ces écrans n'existent plus, même
  // pour qui connaît l'adresse. Le code, lui, reste entier — rallumer
  // l'interrupteur les fait revenir tels quels.
  if (!BREVET_ACTIF) notFound();
