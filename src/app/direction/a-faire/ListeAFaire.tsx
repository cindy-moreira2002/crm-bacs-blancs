      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href="/direction/correction" className="text-xs text-gray-500 hover:underline">
        ...
        {avecTaches.length === 0 && general.length === 0 ? (
          ...
          <div className="space-y-4">
            ...
            {/* Le brevet est un autre examen. Tant qu'il est éteint
                (`BREVET_ACTIF`), ses tâches ne s'affichent pas du tout : elles
                ne sont plus « à faire », puisque plus rien ne s'y inscrit. */}
            {BREVET_ACTIF && avecTaches.some((m) => m.examen === 'DNB') && (
