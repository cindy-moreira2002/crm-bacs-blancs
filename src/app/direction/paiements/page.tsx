...
/**
 * /direction/paiements — le point d'entrée « argent ».
 *
 ...
 * dans /direction/emails, qui est l'historique de TOUS les messages. Ici on parle
      ...
      <div className="max-w-6xl mx-auto px-4 py-8 space-y-5">
        ...
        {!etat.instructions_pretes && (
          <div className="rounded-2xl bg-red-50 border border-red-200 p-4 text-sm text-red-900">
            <p className="font-bold">Aucun IBAN : personne ne peut payer.</p>
            <p className="mt-1">
              Le réglage <span className="font-mono text-xs">paiement_iban</span> est vide :
              l’écran affiché après l’inscription et l’e-mail de confirmation partent sans
              coordonnées bancaires. À remplir (avec le titulaire du compte) dans{' '}
              <Link href="/direction/emails" className="underline font-semibold">
                E-mails → Réglages
              </Link>{' '}
