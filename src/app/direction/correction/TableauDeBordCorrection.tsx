      ...
      <div className="flex flex-wrap items-baseline justify-between gap-2 mb-3">
        <div>
          ...
          <p className="text-xs text-gray-500 mt-0.5">
            ...
            (maths, physique-chimie) : « exercice 2 question b » vaut 3 points{' '}
        ...
        <header className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1 max-w-2xl">
              ...
              question par question — <strong>pour les épreuves à questions</strong> (maths,
              physique-chimie), parce que leurs questions changent à chaque sujet, donc les points
              aussi. La <strong>grille rédigée</strong>,
