...
const ETAPES_FLUX = [
  {
    ...
    texte: 'Deux familles, et elles ne se mélangent pas. Une ÉPREUVE RÉDIGÉE (français, philo, histoire-géo, SES, HLP, SVT, HGGSP) se juge sur une grille écrite UNE FOIS pour l’épreuve : les critères ne changent pas d’un sujet à l’autre, donc un nouveau bac blanc ne demande que son sujet. Une ÉPREUVE À QUESTIONS (maths, physique-chimie) se note question par question : « exercice 2 question b » vaut 3 points dans ce sujet-là, donc chaque bac blanc a SON barème, à écrire dans /direction/bareme, puis à verrouiller avant la première copie.',
  },
  {
    n: '1',
    titre: 'Dépôt',
      ...
      {ouvert && (
        <div className="px-5 pb-5 space-y-5 border-t border-gray-100 pt-4">
          ...
          <p className="text-[11px] text-gray-400">
            ...
            calibration, puis le verrouillage (dans /direction/bareme). À préparer par matière : la grille de
