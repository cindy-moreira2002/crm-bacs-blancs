...
export const TABLES_COUVERTES: FicheTable[] = [
  ...
  },
  {
    ...
    ou_voir: '/direction/bareme → Copies étalons',
  },
  {
  ...
  },
  {
    ...
    ou_voir: '/direction/bareme → Calibration',
  },
  {
    ...
    ou_voir: '/direction/bareme → Calibration → « Figer ce tableau »',
  },
  {
