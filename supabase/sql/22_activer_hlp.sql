-- =====================================================================
--  ACTIVER HLP (a ne jouer QU'APRES validation prof)
--
...
where matiere = 'hlp' and track = 'generale'
  and exercise_type in ('hlp_essai', 'hlp_interpretation');

update public.subject_cards set status = 'active'
where matiere = 'hlp' and track = 'generale'
  and id in ('HLP2027_ESS_01', 'HLP2027_ESS_02', 'HLP2027_ESS_03', 'HLP2027_INT_01', 'HLP2027_INT_02', 'HLP2027_INT_03');
...
-- =====================================================================
-- update public.rubrics           set status = 'draft' where matiere = 'hlp';
-- update public.subject_cards     set status = 'draft' where matiere = 'hlp';
-- update public.dossier_templates set status = 'draft' where matiere = 'hlp';
